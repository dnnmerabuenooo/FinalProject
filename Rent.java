...
public class Rent extends JFrame {
    ...
    public Rent() {
     ...
     // ...
        ...
        rentPic.setIcon(new ImageIcon("C:\\Users\\callv\\OneDrive\\Pictures\\Project\\userRent.png"));
        rentPic.setBounds(0, 0, 1000, 600);
        contentPane.add(rentPic);

        viewEq = new JLabel("");
        viewEq.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                ViewEquipment userView = new ViewEquipment();
                userView.setVisible(true);
                dispose();
            }
        });
        viewEq.setBounds(21, 520, 248, 41);
